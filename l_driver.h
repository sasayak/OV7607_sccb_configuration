...
/*  
 *   This constitues the configuration from the following example: https://github.com/ComputerNerd/ov7670-no-ram-arduino-uno
 *   Which is likely derived from the linux driver.
*/

enum RESOLUTION{VGA,QVGA,QQVGA};
enum COLORSPACE{YUV422,RGB565,BAYER_RGB};

const int SETTINGS_WAIT_TIME = 300;
